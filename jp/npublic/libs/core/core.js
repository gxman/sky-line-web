...
var baseOrigin = "local" == __ce.env ? __ce.baseURL : ""
  ...
  , plPath = "/jp/npublic/libs/widget/"
  , nuPath = "/jp/npublic/libs/nouglify/"
  , libPath = "/jp/npublic/libs/core/"
  , tMapKey = "C4XBZ-P2HWS-5BGOP-64Z2O-FROKK-JEFA7";
_require.config({
    baseUrl: baseOrigin + "/jp/npublic/",
    waitSeconds: 8e3,
    paths: (_paths = {
        css: plPath + "css",
        async: plPath + "async",
...
var getParentWindow = function() {
  ...
  , $comp = function(e) {
    for (var i = e, t = 0; t < i.lib.length; t++)
        i.lib[t] = baseOrigin + "/jp/npublic/js/" + i.lib[t];
  ...
  , $element = function(e, i, n) {
    for (var r = e, t = 0; t < r.lib.length; t++) {
        var a = r.outJs ? "" : "/jp//npublic/eleJs/";
  ...
  , readyFun = function() {
    ...
    $require([needPolyfill, e + "/jp/npublic/commonjs/language/" + t + ".js"], function(e, t) {
  ...
  , pdfPreview = function(i, n, r, a, e, t, o) {
    ...
    (t = -1 < t.indexOf("#") ? t.split("#")[0] : t).endsWith(".pdf") || t.endsWith(".PDF") ? $require(["pl_util"], function() {
        ...
        a && sessionStorage.setItem(n, a)) : e = "/viewfilebizce/h/".concat(encodeURIComponent(t)) : r && n ? (e = "/jp/npublic/opdfjs/web/viewer.html?u=" + n,
        a && (e = e + "&fileName=" + a,
        sessionStorage.setItem(n, a))) : e = "/jp/npublic/opdfjs/web/viewer.html?file=" + encodeURIComponent(t),
  ...
  , getShopImg = function(e, t, i) {
    ...
    (i && isFrontEnv() ? '\n            <img src="/jp/npublic/img/s.png" lazy="' : '\n            <img src="').concat(e, '" ').concat(t, " />\n        ")
};
...
function onlineService() {
    $require(["cmsAjax"], function(e) {
        e.cmsAjax.get("/fwebapi/cms/staff/getStaff").then(function(t) {
            ...
            $require(["pl_service", e + "/jp/npublic/commonjs/language/" + n + ".js"], function(e) {
                $.pl_service({
                    data: t.data.data
                })
            }))
