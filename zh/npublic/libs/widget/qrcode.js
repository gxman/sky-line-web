...
!function(u) {
    ...
    u.fn.qrcode = function(h) {
        "string" == typeof h ? h = {
            ...
            for (var e, r = "", o = t.length, n = 0; n < o; n++)
                1 <= (e = t.charCodeAt(n)) && e <= 127 ? r += t.charAt(n) : (2047 < e ? (r += String.fromCharCode(224 | e >> 12 & 15),
                r += String.fromCharCode(128 | e >> 6 & 63)) : r += String.fromCharCode(192 | e >> 6 & 31),
        ...
        return this.each(function() {
            ...
            : function() {
                ...
                for (var e = u("<table></table>").css("width", h.width + "px").css("height", h.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", h.background), r = h.width / t.getModuleCount(), o = h.height / t.getModuleCount(), n = 0; n < t.getModuleCount(); n++)
                    for (var i = u("<tr></tr>").css("height", o + "px").appendTo(e), a = 0; a < t.getModuleCount(); a++)
                        u("<td></td>").css("width", r + "px").css("background-color", t.isDark(n, a) ? h.foreground : h.background).appendTo(i);
                return e
            }
            )();
            u(t).appendTo(this)
    ...
    l.prototype = {
        ...
        make: function() {
            if (this.typeNumber < 1) {
                for (var t = 1, t = 1; t < 40; t++) {
                    for (var e = m.getRSBlocks(t, this.errorCorrectLevel), r = new C, o = 0, n = 0; n < e.length; n++)
                        o += e[n].dataCount;
                    for (n = 0; n < this.dataList.length; n++) {
                        var i = this.dataList[n];
                        r.put(i.mode, 4),
                        r.put(i.getLength(), p.getLengthInBits(i.mode, t)),
                        i.write(r)
                    }
        ...
        setupTypeInfo: function(t, e) {
            for (var e = this.errorCorrectLevel << 3 | e, r = p.getBCHTypeInfo(e), o = 0; o < 15; o++) {
                var n = !t && 1 == (r >> o & 1);
        ...
        mapData: function(t, e) {
            for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1; 0 < a; a -= 2)
                for (6 == a && a--; ; ) {
                    for (var u, s = 0; s < 2; s++)
                        null == this.modules[o][a - s] && (u = !1,
                        i < t.length && (u = 1 == (t[i] >>> n & 1)),
                        p.getMask(e, o, a - s) && (u = !u),
    ...
    l.createData = function(t, e, r) {
        for (var o = m.getRSBlocks(t, e), n = new C, i = 0; i < r.length; i++) {
            var a = r[i];
            n.put(a.mode, 4),
            n.put(a.getLength(), p.getLengthInBits(a.mode, t)),
            a.write(n)
        }
        for (var u = 0, i = 0; i < o.length; i++)
            u += o[i].dataCount;
        ...
        for (n.getLengthInBits() + 4 <= 8 * u && n.put(0, 4); n.getLengthInBits() % 8 != 0; )
            n.putBit(!1);
        for (; !(n.getLengthInBits() >= 8 * u || (n.put(l.PAD0, 8),
    ...
    l.createBytes = function(t, e) {
        for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), u = 0; u < e.length; u++) {
            ...
            r += s;
            var h = p.getErrorCorrectPolynomial(h)
              , g = new v(i[u],h.getLength() - 1).mod(h);
            a[u] = new Array(h.getLength() - 1);
            for (l = 0; l < a[u].length; l++) {
                var f = l + g.getLength() - a[u].length;
                a[u][l] = 0 <= f ? g.get(f) : 0
            }
        }
        for (var d = 0, l = 0; l < e.length; l++)
            d += e[l].totalCount;
        for (var c = new Array(d), m = 0, l = 0; l < o; l++)
            for (u = 0; u < e.length; u++)
                l < i[u].length && (c[m++] = i[u][l]);
        for (l = 0; l < n; l++)
            for (u = 0; u < e.length; u++)
                l < a[u].length && (c[m++] = a[u][l]);
        return c
    }
    ;
    for (var r = {
        ...
        Q: 3,
        H: 2
    }, n = 0, i = 1, a = 2, s = 3, h = 4, g = 5, f = 6, d = 7, p = {
            ...
            for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++)
                for (var n = 0; n < e; n++) {
                    for (var i = 0, a = t.isDark(o, n), u = -1; u <= 1; u++)
                        if (!(o + u < 0 || e <= o + u))
                            for (var s = -1; s <= 1; s++)
                                n + s < 0 || e <= n + s || 0 == u && 0 == s || a == t.isDark(o + u, n + s) && i++;
                    5 < i && (r += 3 + i - 5)
                }
            for (o = 0; o < e - 1; o++)
                for (n = 0; n < e - 1; n++) {
