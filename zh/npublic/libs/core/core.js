...
function _env() {
    ...
    return "" != location.port ? o = "local" : /test-/.test(tenant.makeDomain) ? o = "test" : /pre-/.test(tenant.makeDomain) && (o = "pre"),
    {
        ...
        videoStaticUrl: ["https://" + ("console" == o ? "" : "pre-") + "omo-oss-video" + ("console" == o ? "110" : "") + ".thefastvideo.com"],
        fileStaticUrl: ["https://" + ("console" == o ? "" : "pre-") + "omo-oss-file" + ("console" == o ? "110" : "") + ".thefastfile.com"],
...
var baseOrigin = "local" == __ce.env ? __ce.baseURL : ""
  ...
  , plPath = "/zh/npublic/libs/widget/"
  , nuPath = "/zh/npublic/libs/nouglify/"
  , libPath = "/zh/npublic/libs/core/"
  , tMapKey = "C4XBZ-P2HWS-5BGOP-64Z2O-FROKK-JEFA7";
_require.config({
    baseUrl: baseOrigin + "/zh/npublic/",
    waitSeconds: 8e3,
    paths: (_paths = {
        css: plPath + "css",
        async: plPath + "async",
    ...
    shim: {
        ...
        pl_service: {
            deps: ["css!" + plPath + "services/pl_service", plPath + "services/service_icon.js"]
        },
        treeSelect: {
...
var getParentWindow = function() {
  ...
  , $comp = function(e) {
    for (var i = e, t = 0; t < i.lib.length; t++)
        i.lib[t] = baseOrigin + "/zh/npublic/js/" + i.lib[t];
  ...
  , $element = function(e, i, n) {
    for (var r = e, t = 0; t < r.lib.length; t++) {  
        var a = r.outJs ? "" : "/zh/npublic/eleJs/";
  ...
  , readyFun = function() {
    ...
    $require([needPolyfill, e + "/zh/npublic/commonjs/language/" + t + ".js"], function(e, t) {
  ...
  , pdfPreview = function(i, n, r, a, e, t, o) {
    ...
    (t = -1 < t.indexOf("#") ? t.split("#")[0] : t).endsWith(".pdf") || t.endsWith(".PDF") ? $require(["pl_util"], function() {
        ...
        a && sessionStorage.setItem(n, a)) : e = "/viewfilebizce/h/".concat(encodeURIComponent(t)) : r && n ? (e = "/zh/npublic/opdfjs/web/viewer.html?u=" + n,
        a && (e = e + "&fileName=" + a,
        sessionStorage.setItem(n, a))) : e = "/zh/npublic/opdfjs/web/viewer.html?file=" + encodeURIComponent(t),
  ...
  , fileDownloadFun = function(e, t, i) {
    ...
    i ? (i = "",
    -1 < e.indexOf("?") && (e = (r = e.split("?"))[0],
    i = r[1]),
    (r = e.split("/"))[r.length - 1] = encodeURIComponent(r[r.length - 1]),
    r = r.join("/"),
    i && (r = r + "?" + i),
    r = "/downfilebizce/get?n=".concat(encodeURIComponent(r)),
    n.href = r) : (n.download = t,
    n.href = e),
    n.target = "_blank",
  ...
  , getShopImg = function(e, t, i) {
    ...
    (i && isFrontEnv() ? '\n            <img src="/zh/npublic/img/s.png" lazy="' : '\n            <img src="').concat(e, '" ').concat(t, " />\n        ")
};
...
function highLightKeywords() {
    window.pageObj && "3" == pageObj.pageType && $require(["pl_util", "cmsAjax"], function(e, t) {
        var n, a = $.getSearch();
        void 0 !== a._preview && a._preview_tid && a._preview_id && ($("body").append('<div style="width:100%;background:#f2f2f2;color:#F56C6C;font-weight:bold;text-align:center;padding:10px;border-bottom:1px solid #ccc;position:fixed;top:0;left:0;z-index:9999999">当前为预览模式，预览有效期过后将无法访问，请勿将预览链接用作正式使用。</div>'),
...
function onlineService() {
    $require(["cmsAjax"], function(e) {
        e.cmsAjax.get("/fwebapi/cms/staff/getStaff").then(function(t) {
            ...
            $require(["pl_service", e + "/zh/npublic/commonjs/language/" + n + ".js"], function(e) {
                $.pl_service({
                    data: t.data.data
                })
            }))
...
$(function() {
    ...
    $require([e], function(e) {
        ...
        getThirdCode(),
        getLixiaoCode(),
        location.hostname != tenant.makeDomain && location.hostname != tenant.mobileMakeDomain || highLightKeywords(),
