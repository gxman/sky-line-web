...
var smsFlag = !1
  ...
  , interwords = ("local" == __ce.env ? "http://" + tenant.makeDomain : "") + "/zh/npublic/commonjs/language/" + ("hn" == tenant.language ? "es" : tenant.language) + ".js";
function ttsPlay() {
    var e = $("[ttsPlay]");
    0 < e.length && e.each(function(e, t) {
        ...
        t = "/zh/npublic/commonjs/nouglify/audioPlay/ttsPlay.js",
        r = {
            element: s
        },
        n && a && o && i ? (t = "/zh/npublic/commonjs/nouglify/audioPlay/audioPlay.js",
...
$(function() {
    ...
    "miniprogram" === window.__wxjs_environment && $require(["/zh/npublic/commonjs/jweixin/jweixin.js", "pl_util"], function() {
...
function accessLimit() {
    ...
    e && !t && (a = e[9],
    o = e[10],
    "1" != a && "1" != o || $require(["cmsAjax", "/zh/npublic/commonjs/jsencrypt.js"], function(t, e) {
        ...
        t.cmsAjax.get("/fwebapi/visitor/lowcode/designToken/getToken", {}, {
            ...
            try {
                t.cmsAjax.get("/fwebapi/visitor/lowcode/designToken/getI", {}, {
                    ...
                    ("1" == e.data.status && "1" == a || "2" == e.data.status && "1" == o) && (location.href = "/zh/npublic/plugins/accessLimit/index.html")
                })
            } catch (e) {}
        })
    })))
...
function festival() {
    isFrontEnv() && $require(["cmsAjax"], function(e) {
        e.cmsAjax.get("/fwebapi/cms/lowcode/festivalPendant/getSettings").then(function(e) {
            ...
            t.isOpen && e && $require(["/zh/npublic/commonjs/restival.js"], function(e) {
                e.init(t)
            })))
        })
    })
    ...
    isFrontEnv() && !window.noSms && $(window).on("mousemove scroll touchmove tap click keydown", function() {
        ...
        $require(["cmsAjax", "pl_util"], function(e) {
            ...
            e.cmsAjax.postJson(n, o).then(function(n) {
                ...
                $require(["css!/npublic/commonjs/smartService/them/".concat(e, ".css"), "/zh/npublic/commonjs/smartService/smartService.js"], function(e, t) {
                    n.data.domain = a;
                    new t(n.data)
                }))
            })
...
function wxShare() {
    $require(["cmsAjax", "/zh/npublic/commonjs/jweixin/jweixin.js", "pl_util"], function(e) {
        var t = {
